const { getUser, logUser, logout } = require('../controller/auth')
...
module.exports = (router) => {
    ...
    .post('/signup', passport.authenticate('signup', { successRedirect: 'http://localhost:3000/login', failureRedirect: 'http://localhost:3000/signup-failed' }))
